<x-app-layout>
    ...
    <div class="flex justify-center pt-10 gap-20">
        <div class="flex-none">
            <h1 class="text-2xl text-black font-bold">Permissions</h1>
        </div>
        <div class=" w-64">
            <h1>
                <button class="bg-blue-500 text-red-500 py-2 px-4 rounded hover:bg-blue-600">
    ...
    <div class="mt-10 max-w-4xl text-center mx-auto bg-white p-8 shadow-lg rounded-lg">
